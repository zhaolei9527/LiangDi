...
public class Notifier {
    ...
    public synchronized void onNewMsg(Message message) {
        ...
        if (!BaseChatActivity.chating) {
            Log.e(TAG + "单条更新", message.getBody().toString());
    ...
    public synchronized void onNewMesg(List<Message> messages) {
        ...
        if (!EasyUtils.isAppRunningForeground(appContext)) {
            ...
            Log.e(TAG, "app NOTis running in backgroud");
    ...
    protected void sendNotification(Message message, boolean isForeground, boolean numIncrease) {
        ...
        try {
            ...
            if (notificationInfoProvider != null) {
                ...
                Intent customIntent = new Intent(appContext, BaseChatActivity.class);
                customIntent.putExtra(Config.EXTRA_SERVICE_IM_NUMBER, "liangdinvshen");
