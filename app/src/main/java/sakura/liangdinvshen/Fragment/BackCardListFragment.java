...
import sakura.liangdinvshen.Adapter.BackCardListAdapter;
...
public class BackCardListFragment extends Fragment {
    ...
    private void bankIndex() {
        ...
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "bank/index", "bank/index", params, new VolleyInterface(context) {
            ...
            public void onMySuccess(String result) {
                ...
                try {
                    BankIndexBean bankIndexBean = new Gson().fromJson(decode, BankIndexBean.class);
                    if ("1".equals(String.valueOf(bankIndexBean.getStu()))) {
                        ...
                        if (p == 1) {
                            adapter = new BackCardListAdapter(bankIndexBean.getRes(), context, ll_empty);
