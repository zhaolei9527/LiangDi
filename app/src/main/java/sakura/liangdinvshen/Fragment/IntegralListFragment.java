...
import sakura.liangdinvshen.Adapter.IntegralListAdapter;
...
public class IntegralListFragment extends Fragment {
    ...
    private void mingxiCaiwu() {
        ...
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "mingxi/jifen", "mingxi/jifen", params, new VolleyInterface(context) {
            @Override
