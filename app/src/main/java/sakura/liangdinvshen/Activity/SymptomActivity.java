...
public class SymptomActivity extends BaseActivity {
    ...
    private CheckBox btn_15;
    private CheckBox btn_16;
    private CheckBox btn_17;
    private CheckBox btn_18;
    private CheckBox btn_19;
    private CheckBox btn_20;
    private CheckBox btn_21;
    private CheckBox btn_22;
    ...
    private CheckBox btn_35;
    private CheckBox btn_36;
    private CheckBox btn_37;
    private CheckBox btn_38;
    private CheckBox btn_39;
    private CheckBox btn_40;
    private CheckBox btn_41;
    private CheckBox btn_42;
    private CheckBox btn_43;
    private CheckBox btn_44;
    private CheckBox btn_45;
    private CheckBox btn_46;
    private CheckBox btn_47;
    ...
    protected void initview() {
        ...
        btn_15 = (CheckBox) findViewById(R.id.btn_15);
        btn_16 = (CheckBox) findViewById(R.id.btn_16);
        btn_17 = (CheckBox) findViewById(R.id.btn_17);
        btn_18 = (CheckBox) findViewById(R.id.btn_18);
        btn_19 = (CheckBox) findViewById(R.id.btn_19);
        btn_20 = (CheckBox) findViewById(R.id.btn_20);
        btn_21 = (CheckBox) findViewById(R.id.btn_21);
        btn_22 = (CheckBox) findViewById(R.id.btn_22);
        ...
        btn_35 = (CheckBox) findViewById(R.id.btn_35);
        btn_36 = (CheckBox) findViewById(R.id.btn_36);
        btn_37 = (CheckBox) findViewById(R.id.btn_37);
        btn_38 = (CheckBox) findViewById(R.id.btn_38);
        btn_39 = (CheckBox) findViewById(R.id.btn_39);
        btn_40 = (CheckBox) findViewById(R.id.btn_40);
        btn_41 = (CheckBox) findViewById(R.id.btn_41);
        btn_42 = (CheckBox) findViewById(R.id.btn_42);
        btn_43 = (CheckBox) findViewById(R.id.btn_43);
        btn_44 = (CheckBox) findViewById(R.id.btn_44);
        btn_45 = (CheckBox) findViewById(R.id.btn_45);
        btn_46 = (CheckBox) findViewById(R.id.btn_46);
        btn_47 = (CheckBox) findViewById(R.id.btn_47);
        ...
        checkBoxes.add(btn_15);
        checkBoxes.add(btn_16);
        checkBoxes.add(btn_17);
        checkBoxes.add(btn_18);
        checkBoxes.add(btn_19);
        checkBoxes.add(btn_20);
        checkBoxes.add(btn_21);
        checkBoxes.add(btn_22);
        ...
        checkBoxes.add(btn_35);
        checkBoxes.add(btn_36);
        checkBoxes.add(btn_37);
        checkBoxes.add(btn_38);
        checkBoxes.add(btn_39);
        checkBoxes.add(btn_40);
        checkBoxes.add(btn_41);
        checkBoxes.add(btn_42);
        checkBoxes.add(btn_43);
        checkBoxes.add(btn_44);
        checkBoxes.add(btn_45);
        checkBoxes.add(btn_46);
        checkBoxes.add(btn_47);
    }
        ...
        tv_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EventBus.getDefault().post(
                        new BankEvent(stringBuilder.toString(), "zhengzhuang"));
            }
        });
