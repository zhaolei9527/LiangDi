 ...
 * 功能描述：
 */
public class ChouChouActivity extends BaseActivity {
     ...
     * 臭臭记录
     */
    private void suckleSmelly() {
        HashMap<String, String> params = new HashMap<>(3);
        params.put("key", UrlUtils.KEY);
        params.put("uid", String.valueOf(SpUtil.get(context, "uid", "")));
        params.put("time", RecordFragment.currentDate.toString());
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "suckle/smelly", "suckle/smelly", params, new VolleyInterface(context) {
            @Override
