...
import sakura.liangdinvshen.Fragment.FinancialListFragment;
 ...
 * 功能描述：
 */
public class FinancialActiivity extends BaseActivity {
    ...
    protected int setthislayout() {
        return R.layout.activity_financial_list_layout;
    }
    ...
    protected void initListener() {
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                financialListFragment.setArguments(args);
                getSupportFragmentManager().beginTransaction().replace(R.id.fl_content, financialListFragment).commit();
