 ...
 * 功能描述：
 */
public class BreastFeedActivity extends BaseActivity {
    ...
    protected int setthislayout() {
        return R.layout.activity_breastfeed;
    }
    ...
    private void suckleSuckle() {
        ...
        VolleyRequest.RequestPost(context, UrlUtils.BASE_URL + "suckle/suckle", "suckle/suckle", params, new VolleyInterface(context) {
            @Override
    ...
    protected void onDestroy() {
        super.onDestroy();
        App.getQueues().cancelAll("suckle/suckle");
    }
