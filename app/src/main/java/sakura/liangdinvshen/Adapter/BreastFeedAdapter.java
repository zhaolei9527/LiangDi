...
public class BreastFeedAdapter extends RecyclerView.Adapter<BreastFeedAdapter.ViewHolder> {
    ...
    public BreastFeedAdapter(List<SuckleSuckleBean.ResBean> list, Context context) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tv_size.setText(resBean.getAmount());
        holder.tv_time.setText(resBean.getStart_time());
        holder.tv_type.setText(resBean.getType());
    }
