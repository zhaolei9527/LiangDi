...
public class CollectionNewsListAdapter extends RecyclerView.Adapter<CollectionNewsListAdapter.ViewHolder> {

    Context mContext;
    private ArrayList<CollectionNewsBean.ResBean> datas = new ArrayList();

    public ArrayList<CollectionNewsBean.ResBean> getDatas() {
        return datas;
    }

    public CollectionNewsListAdapter(List<CollectionNewsBean.ResBean> list, Context context) {
        this.datas = (ArrayList<CollectionNewsBean.ResBean>) list;
